    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-blue-800 text-white shadow-md">
        <div className="container mx-auto px-4 py-5">
          ...
          <p className="text-blue-100 mt-1">Comprehensive analysis of unemployment trends, job vacancies, and career opportunities</p>
        </div>
      </header>
      ...
      <nav className="bg-white shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex space-x-1 overflow-x-auto">
            ...
            <TabButton active={activeTab === 'unemployment'} onClick={() => setActiveTab('unemployment')}>Unemployment Trends</TabButton>
            <TabButton active={activeTab === 'education'} onClick={() => setActiveTab('education')}>Education Impact</TabButton>
            <TabButton active={activeTab === 'regional'} onClick={() => setActiveTab('regional')}>Regional Analysis</TabButton>
            <TabButton active={activeTab === 'demographic'} onClick={() => setActiveTab('demographic')}>Demographics</TabButton>
            <TabButton active={activeTab === 'occupation'} onClick={() => setActiveTab('occupation')}>Occupations & Vacancies</TabButton>
            <TabButton active={activeTab === 'career'} onClick={() => setActiveTab('career')}>Career Advisory</TabButton>
          </div>
        </div>
      </nav>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card>
        ...
        <p className="text-gray-700 mb-3">
          Canada's labor market has stabilized post-pandemic, with unemployment near historic lows at 6.6% as of February 2025. However, structural and frictional unemployment remain concentrated among youth, low-educated individuals, and certain regions.
        </p>
        <p className="text-gray-700 mb-3">
          High-skilled, high-wage professions show low unemployment and stability during downturns, while low-skilled sectors face higher volatility. There are persistent regional disparities, with Western provinces maintaining lower unemployment rates than Atlantic provinces.
        </p>
    ...
    <Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border rounded p-4">
          ...
          <p className="text-sm text-gray-600">Expand internships, apprenticeships, and tax incentives for hiring youth.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Education & Upskilling</h3>
          <p className="text-sm text-gray-600">Prioritize adult education and vocational training aligned with high-demand sectors.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Regional Development</h3>
          <p className="text-sm text-gray-600">Invest in high-unemployment regions and facilitate interprovincial labor mobility.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Labor Market Matching</h3>
          <p className="text-sm text-gray-600">Deploy AI-driven platforms to connect job seekers with vacancies and address skill gaps.</p>
        </div>
      </div>
    </Card>
  </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card className="md:col-span-2">
        ...
        <p className="mt-4 text-gray-700">
          Canada's national unemployment rate is projected to remain near historic lows (around 6.4%) over the next 12 months, with modest seasonal fluctuations. The forecast shows stability in the overall labor market.
        </p>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <p className="text-gray-700">
            Our predictive models identify the most critical factors affecting unemployment risk. Age, education level, and geographic location emerge as the strongest predictors.
          </p>
          ...
          <p className="text-sm text-gray-600">
            Gender has minimal importance, suggesting that youth, low education, and regional economic conditions are key risk factors.
          </p>
        </div>
      </div>
    </Card>
        ...
        <Card>
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full mr-2 mt-0.5">1</span>
              <div>
                <h3 className="font-medium">Expand Adult Education Access</h3>
                <p className="text-sm text-gray-600">Increase funding for adults returning to complete high school or post-secondary education</p>
              </div>
            </div>
            <div className="flex items-start">
              <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full mr-2 mt-0.5">2</span>
              <div>
                <h3 className="font-medium">Target High-Demand Fields</h3>
                <p className="text-sm text-gray-600">Align educational programs with sectors experiencing high vacancy rates</p>
              </div>
            </div>
            <div className="flex items-start">
              <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full mr-2 mt-0.5">3</span>
              <div>
                <h3 className="font-medium">Enhance Vocational Training</h3>
                <p className="text-sm text-gray-600">Invest in skilled trades and technical certifications to address labor shortages</p>
              </div>
            </div>
          </div>
        </Card>
    ...
    <Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="border rounded p-4">
          ...
          <p className="text-sm text-gray-600">Invest in diversifying economies in resource-dependent regions to reduce vulnerability to sector-specific shocks.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Infrastructure Investment</h3>
          <p className="text-sm text-gray-600">Develop transportation and digital infrastructure in high-unemployment regions to improve connectivity.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Regional Tax Incentives</h3>
          <p className="text-sm text-gray-600">Create targeted tax incentives for businesses establishing operations in high-unemployment regions.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Relocation Support</h3>
          <p className="text-sm text-gray-600">Offer financial assistance for workers willing to relocate from high to low unemployment regions.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Regional Training Programs</h3>
          <p className="text-sm text-gray-600">Develop education and training programs tailored to the specific needs of regional labor markets.</p>
        </div>
        <div className="border rounded p-4">
          <h3 className="font-medium mb-2">Remote Work Hubs</h3>
          <p className="text-sm text-gray-600">Establish remote work hubs in high-unemployment regions to connect local talent with national job opportunities.</p>
        </div>
      </div>
    </Card>
  </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card className="md:col-span-2">
        ...
        <p className="text-gray-700 mb-4">
          Based on comprehensive analysis of unemployment trends, job vacancies, and occupational forecasts, we can provide targeted career guidance to help individuals navigate the Canadian job market effectively.
        </p>
        ...
        <div className="space-y-4">
          <div className="border rounded p-4">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Estimate your personal unemployment risk based on education, age, location and other factors.
            </p>
